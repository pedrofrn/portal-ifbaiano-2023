...
if (function_exists('register_sidebar')) {
	...
	{
		echo 'Você está aqui: <a href="' . home_url() . '" rel="nofollow">Página Inicial</a>';
		if (is_single()) {
			echo " &nbsp;&nbsp;&#187;&nbsp;&nbsp; ";
			the_title();
		} elseif (is_page()) {
...
// add_action( 'admin_init', 'infoCurso_add_custom_box', 1 );
	...
	function register_taxonomy_posttype()
	{
		register_taxonomy(
			'categoria_concursos',
			'concursos',
			array(
				'hierarchical' => true,
				'label' => 'Categorias de Concursos',
				'query_var' => true,
				'public' => true,
				'show_ui' => true,
				'show_admin_column' => true,
				'show_in_nav_menus' => true,
				'rewrite' => array('slug' => 'categoria_concursos'),
			)
		);
		...
		register_taxonomy(
			...
			array(
				...
				'query_var' => true,
				'rewrite' => array('slug' => 'categoria_cursos'),
			)
		);
	}
	add_action('init', 'register_taxonomy_posttype');
