...
<head>
	...
	<meta property="creator.productor"
		content="http://estruturaorganizacional.dados.gov.br/id/unidade-organizacional/100920">
	...
	<link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/contrastePreto.css" type="text/css"
		id="contrastePreto" media="screen" disabled />
	<link rel="stylesheet" href="<?php bloginfo('stylesheet_url'); ?>" type="text/css" title="default" id="estiloPadrao"
		media="screen" />
	<title>
		<?php bloginfo('name'); ?>
		<?php wp_title(); ?>
				...
				<div id="CentroHeaderEsquerda">
					...
					<div id="CentroHeaderEsquerdaMeio">
						<a class="nomeUnidade" href="<?php echo bloginfo('home'); ?>">
							<?php
							if (is_home()) {
								// Exibe o nome do blog como um título principal (h1) na página inicial
								echo '<h1 style="font-size: 2.5rem;margin:0;">' . esc_html(get_bloginfo('name')) . '</h1>';
							} else {
								// Exibe o nome do blog em texto simples em outras páginas
					...
					<div id="RedesSociais">
						...
						if (!empty($link_instagram)):
							...
							<div id="redeSocialInstagram">
								<a href="<?php echo esc_url($link_instagram); ?>" target="_blank" title="Instagram"
						...
						<?php if (!empty($link_facebook)): ?>
							<div id="redeSocialFacebook">
								<a href="<?php echo esc_url($link_facebook); ?>" target="_blank" title="Facebook"
						...
						<?php if (!empty($link_youtube)): ?>
							<div id="redeSocialYoutube">
								<a href="<?php echo esc_url($link_youtube); ?>" target="_blank" title="Youtube"
