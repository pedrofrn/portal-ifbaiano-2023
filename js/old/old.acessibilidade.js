...
function setarTamanho(tam){
    ...
    var menu = document.getElementById("colunaEsquerda");
    var rodape = document.getElementById("containerRodape");
    var topo = document.getElementById("containerCabecalho");
...
function alterarTamanho(sinal){
    ...
    if (tamanhoCookie != ""){
        ...
        else  if (sinal == "menos" && tamanho > 12) {
            tamanho -= 1;
        }
        else if (sinal == "igual") {
            tamanho = 13;
